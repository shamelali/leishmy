...
export default function UsersPage() {
  ...
  const roleOrder = ["artist", "studio", "customer", "admin"];
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Manage clients, MUAs, and studios
              </p>
            </div>
          </div>
          <button
            ...
            className={`px-3 py-1.5 text-sm rounded-lg border transition-colors ${
              groupByRole
                ...
                : "bg-white text-gray-600 border-gray-200 hover:bg-gray-50 dark:bg-neutral-900 dark:text-gray-400 dark:border-neutral-700 dark:hover:bg-neutral-800"
            }`}
          >
            {groupByRole ? "Ungroup" : "Group by Role"}
          </button>
        </div>
        ...
        {fetchError ? (
          ...
          <div className="space-y-6">
            {roleOrder.map((role) => {
              ...
              const color = ROLE_COLORS[role] || "text-gray-500";
              return (
                <div
                  key={role}
                ...
                >
                  <div className="px-4 py-3 border-b border-gray-100 dark:border-neutral-800 flex items-center gap-2">
                    ...
                    <h2 className="text-sm font-semibold text-gray-900 dark:text-white capitalize">
                      {role === "customer" ? "Clients" : role === "artist" ? "MUAs" : `${role}s`}
                    </h2>
                    ...
                    <table className="w-full text-sm min-w-[760px]">
                      <thead className="bg-gray-50 dark:bg-neutral-800 text-gray-500 dark:text-gray-400">
                        <tr>
                          ...
                          <th className="text-left font-medium px-3">Status</th>
