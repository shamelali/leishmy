          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {loading ? (
              ...
              <div className="col-span-full text-center py-16">
                ...
                <p className="text-gray-400 dark:text-gray-500 text-lg">{t('emptyHeading')}</p>
                <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">{t('emptyText')}</p>
              </div>
            ) : (
              events.map((event) => (
                <div
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-4 flex items-center gap-2">
                      {event.ticketUrl && (
                        ...
                        >
                          {t('getTickets')} <ExternalLink className="w-3.5 h-3.5" />
                        </a>
                      )}
                      {event.organizerName && (
