...
export const featuredArtists: Artist[] = [
  {
    ...
    verified: true,
    responseTime: "< 1 hour",
    categories: ["Bridal", "Soft Glam"],
    specialties: [],
    languages: ["English", "Bahasa Melayu"],
    bio: "Specializing in timeless bridal beauty for over 10 years.",
    portfolio: [],
    featured: true,
    demo: false,
  },
  {
    ...
    categories: ["Hijab Styling", "Event Glam"],
    specialties: [],
    languages: ["English", "Bahasa Melayu", "Mandarin"],
    bio: "Certified makeup artist passionate about enhancing natural beauty.",
    portfolio: [],
    featured: true,
    demo: false,
  },
  {
    id: "3",
    name: "Mei Ling Artistry",
    slug: "mei-ling-artistry",
    ...
    verified: true,
    responseTime: "< 1 hour",
    categories: ["Editorial", "Airbrush"],
    specialties: [],
    languages: ["English", "Mandarin", "Cantonese"],
    bio: "Award-winning editorial makeup artist with a passion for avant-garde looks.",
    portfolio: [],
    featured: true,
    demo: false,
  },
